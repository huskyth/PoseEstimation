    ...
    def __init__(self,
        ...
        if test:
            ...
            if not with_damaged_actions:
                ...
                damaged_actions = 'Directions-1', 'Directions-2', 'Discussion-1', 'Discussion-2', 'Eating-1', \
                                  'Eating-2', 'Greeting-1', 'Greeting-2', 'Phoning-2', 'Posing-1', \
                                  'Posing-2', 'Purchases-1', 'Purchases-2', 'Sitting-1', 'Sitting-2', 'SittingDown-1', \
                                  'SittingDown-2', 'Smoking-1', 'Smoking-2', 'TakingPhoto-1', 'TakingPhoto-2',\
                                  'Waiting-1', 'Waiting-2', 'Walking-1', 'Walking-2', 'WalkingDog-1', 'WalkingDog-2',\
