...
h36m_root = '/home/zjlab/lizao/human3.6'
...
una_dinosauria_root = '/home/zjlab/lizao/human3.6/extra/una-dinosauria-data/h36m'
...
bboxes = np.load('/home/zjlab/lizao/human3.6/extra/bboxes-Human36M-GT.npy', allow_pickle=True).item()
...
if BBOXES_SOURCE != 'GT':
    ...
    detections_paths = {
        'MRCNN': {
            'train': "/home/zjlab/lizao/human3.6/extra/train_human36m_MRCNN.json",
            'test': "/home/zjlab/lizao/human3.6/extra/test_human36m_MRCNN.json"
        },
        'SSD': {
