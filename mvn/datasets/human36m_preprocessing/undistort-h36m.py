...
h36m_root = os.path.join('D:/3d/code/h36m-fetch-master', "processed")
labels_multiview_npy_path = 'D:/3d/code/h36m-fetch-master/extra/human36m-multiview-labels-GTbboxes.npy'
number_of_processes = int(16)
