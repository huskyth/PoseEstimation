...
def parse_args():
    ...
    parser.add_argument('--inp_dim', dest='inp_dim', type=str, default='256', help='inpdim')
    ...
    # parser.add_argument("--vid1", type=str, default="C:/Users/ADMIN/Desktop/VideoPose/real-time-pose-estimation/outputs/video01.avi",
    #                     help="Path to video from camera 1")
    # parser.add_argument("--vid2", type=str, default="C:/Users/ADMIN/Desktop/VideoPose/real-time-pose-estimation/outputs/video02.avi",
    #                     help="Path to video from camera 2")
    parser.add_argument("--vid1", type=str,
                        default="C:/Users/ADMIN/Desktop/EasyMocap-master/video01.avi",
                        help="Path to video from camera 1")
    parser.add_argument("--vid2", type=str,
                        default="C:/Users/ADMIN/Desktop/EasyMocap-master/video02.avi",
                        help="Path to video from camera 2")
...
def det_preproc(streams, camera_labels, inp_dim):    
    ...
    for v in range(len(streams)):
        ...
        #       0.99413,
        #       2.37863]
        R1 = [[0.7643283700090453, 0.6441729404474333, 0.02904075747331658],
              [0.23801618763510157, -0.23998357640341925, -0.9411462040938574],
              [-0.5992916128421694, 0.7262569144950926, -0.3367498432443579]]

        t1 = [-0.44203033245507173,
              0.8865368198457098,
              2.136153569175561]
        ...
        #       0.83449,
        #       2.32195]
        R2 = [[-0.6572640488163715, 0.7513167408836294, 0.05938960347999933],
              [0.16276901659228554, 0.21845056273767893, -0.9621775298130648],
              [-0.7358737781515866, -0.6227379115708247, -0.26587078839413125]]
        t2 = [-0.03827162680053241,
              0.8646325225082756,
              2.3813402172452536]
...
if __name__ == '__main__':
    ...
    temp_path = './temp_folder/torch_pipeline_2cam/'
